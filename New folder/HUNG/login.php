                ...
                <div class="col-lg-12 login-form">
                    <div class="col-lg-12 login-form">
                        <form method="post">
                            ...
                            <div class="form-group">
                                <label class="form-control-label" name="Upassword">PASSWORD</label>
                            ...
                            <div class="col-lg-12 loginbttm">
                                <div class="col-lg-6 login-btm login-text">
                                    <!-- Error Message -->
                                    <a type="text" onclick="window.location.href='register.php'" class="btn btn-outline-primary">Register</a>
                                </div>
                                <div class="col-lg-6 login-btm login-button">
                                    <button type="submit" name="login" class="btn btn-outline-primary" class="Login">LOGIN</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        <?php 
           ...
           if(isset($_POST['login']))
           {
               ...
               if($check_login>0) {
                   ...
                   echo "<script>alert('Bạn đăng nhập thất bại')</script>";
               }
           }
        ?>
